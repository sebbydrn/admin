            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            {{-- Form --}}
                            {!! Form::open(['method' => 'POST', 'route' => 'philrice_stations.store']) !!}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('station_code') ? ' is-invalid' : '' }}" name="station_code" value="{{old('station_code')}}">
