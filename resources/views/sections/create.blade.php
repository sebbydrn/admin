            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            {{-- Form --}}
                            {!! Form::open(['method' => 'POST', 'route' => 'sections.store']) !!}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="radio" name="is_dynamic" value="1" class="form-check-input" {{(old('is_dynamic') == "1") ? 'checked' : ''}} {{(old('is_dynamic') == "") ? 'checked' : ''}}>
                                            <label class="form-check-label">Yes</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" name="is_dynamic" value="0" class="form-check-input" {{(old('is_dynamic') == "0") ? 'checked' : ''}}>
                                            <label class="form-check-label">No</label>
                                        </div>
                                    </div>
